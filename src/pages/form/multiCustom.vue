<template>
  <view>
    <mt-navbar fixed title="MultiCustom 联动面板" emit="true" :config="pagenav" @backClick="formClick"></mt-navbar>
    <view class="formPage">
      <ry-title title="自定义配置">
        <view class="formContent">
          <mt-form :formData="multiCustomFormData" @customSearch="customSearchFun"></mt-form>
        </view>
      </ry-title>
    </view>
  </view>
